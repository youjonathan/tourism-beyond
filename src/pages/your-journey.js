      ...
      <main>
        <div className="relative w-full h-screen">
          ...
          <div className="relative h-full text-light flex flex-col items-center justify-center">
            <h2 className="font-dancing text-2xl sm:text-3xl md:text-4xl">
              embark on the
            </h2>
            <motion.h1
              className="font-playfair font-black text-4xl sm:text-7xl md:text-8xl lg:text-[8rem] uppercase"
        ...
        <div>
          ...
          <Layout className="bg-mygray px-8 xl:px-32 py-18 md:py-24 xl:py-32">
            <div className="w-full md:hidden flex flex-col items-center justify-items-center">
              <div className="pb-6">
                <h3 className="font-playfair font-bold text-3xl text-center pb-4">
                  Planning
